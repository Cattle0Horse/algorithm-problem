/**
 * @file leetcode_28.cpp
 * @author Cattle_Horse (CattleHorse@duck.com)
 * @brief https://leetcode.cn/problems/find-the-index-of-the-first-occurrence-in-a-string/
 * @version 0.1
 * @date 2024-04-24
 *
...
public:
    int strStr(std::string haystack, std::string needle) {
        return OI::String::KMP::getFirstIndex(haystack.begin(), haystack.end(), needle.begin(), needle.end());
    }
};
